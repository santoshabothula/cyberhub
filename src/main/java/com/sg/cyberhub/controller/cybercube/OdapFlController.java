...
public class OdapFlController {
    ...
    public Mono<Account> createAnAccount(@RequestBody Accountv3Request request) {
    ...
    @ApiResponse(responseCode = "200", description = "Ok")
    public Mono<FinancialLossResults> getCATFinancialLoss(@PathVariable String accountId, @PathVariable String analysisId) {
    ...
    @ApiResponse(responseCode = "200", description = "Ok")
    public Mono<FinancialLossResultsYlt> getCATYLTPresignedURL(@PathVariable String accountId, @PathVariable String analysisId) {
    ...
    @ApiResponse(responseCode = "200", description = "Ok")
    public Mono<FinancialLossResults> getFinancialLossByTypeRiskAdjustedBaseline(@PathVariable String accountId, @PathVariable String analysisId, @PathVariable String type) {
    ...
    @ApiResponse(responseCode = "200", description = "Ok")
    public Mono<FinancialLossResultsYlt> getYLTPresignedURLResultByTypeRFABASELINE(@PathVariable String accountId, @PathVariable String analysisId, @PathVariable String type) {
    ...
    public Mono<Accountv3Request> retrieveAccountInformation(@PathVariable String accountId) {
    ...
    @ApiResponse(responseCode = "200", description = "Ok")
    public Mono<RunAnalysisResponse> runAnalysis(@PathVariable String accountId) {
    ...
    public Mono<List<SearchCompanyDto>> searchCompany(@RequestParam String query) {
